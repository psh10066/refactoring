...
class BookingTest {
    ...
    void talkback() {
        ...
        LocalDateTime noonPeekday = LocalDateTime.of(2022, 1, 20, 19, 0);
        LocalDateTime peekday = LocalDateTime.of(2022, 1, 15, 19, 0);

        assertFalse(Booking.createBooking(noTalkbackShow, noonPeekday).hasTalkback());
        assertTrue(Booking.createBooking(talkbackShow, noonPeekday).hasTalkback());
