package com.psh10066.refactoring._03_long_function._08_introdce_parameter_object;
...
public class StudyDashboard {
    ...
    // Introduce Field : 여러 메소드에서 반복되는 파라미터를 필드로 선언한다.
    ...
    private String getMarkdownForParticipant(Participant p) {
        return String.format("| %s %s | %.2f%% |\n", p.username(), checkMark(p, this.totalNumberOfEvents), getRate(new ParticipantPrinter(this.totalNumberOfEvents, p)));
    }
